...
public class TicketParser extends DefaultHandler {
    ...
    public void printTicket(Reader in) throws TicketPrinterException  {
        ...
        try {
            ...
            throw new TicketPrinterException("ticket parser - El archivo no es un documento XML valido. Error de analisis.", eSAX);
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        case OUTPUT_TICKET:
            if ("image".equals(qName)){
                ...
                text = null;
                 ...
                 m_oOutputPrinter.printText(m_iTextStyle, DeviceTicket.alignLeft( m_system.getResourceAsText(text.toString()), 40));
            } else if ("text".equals(qName)) {
                if (m_iTextLength > 0) {
                    switch(m_iTextAlign) {
        ...
        case OUTPUT_FISCAL:
            if ("fiscalreceipt".equals(qName)) {
                ...
                m_printer.getFiscalPrinter().printLine(text.toString(), m_dValue1, m_dValue2,0);
                text = null;               
            } else if ("message".equals(qName)) {
