...
public class TicketLineInfo implements SerializableWrite, SerializableRead, Serializable {
    ...
    /** Creates new TicketLineInfo */   
     public TicketLineInfo(String productid, double dMultiply, double dPrice, double dPrice2, TaxInfo tax, Properties props) {
        init(productid, dMultiply, dPrice, dPrice2, tax, props);
    }
     
    public TicketLineInfo(String productid, double dMultiply, double dPrice, double dPrice2, TaxInfo tax) {
        init(productid, dMultiply, dPrice, dPrice2, tax, new Properties());
    }
    
    public TicketLineInfo(String productname, String producttaxcategory, double dMultiply, double dPrice, double dPrice2, TaxInfo tax) {
        
        Properties props = new Properties();
        props.setProperty("product.name", productname);
        props.setProperty("product.taxcategoryid", producttaxcategory);
        init(null, dMultiply, dPrice, dPrice2,  tax, props);
    }
     
     public TicketLineInfo() {
        init(null, 0.0, 0.0, 0.0 ,null, new Properties());
    }
     
    public TicketLineInfo(ProductInfoExt product, double dMultiply, double dPrice, double dPrice2, TaxInfo tax, Properties attributes) {
        ...
        init(pid, dMultiply, dPrice, dPrice2, tax, attributes);
    }    

    public TicketLineInfo(ProductInfoExt oProduct, double dPrice, double dPrice2, TaxInfo tax, Properties attributes) {
        this(oProduct, 1.0, dPrice, dPrice2, tax, attributes);
    }
        
    public TicketLineInfo(TicketLineInfo line) {  
        init(line.productid, line.multiply, line.price, line.price2,  line.tax, (Properties) line.attributes.clone());
    }
    
    private void init(String productid, double dMultiply, double dPrice, double dPrice2, TaxInfo tax, Properties attributes) {
    ...
    public void setPrice2(double dValue){
        price2 = dValue;
    }
