...
//        m_propsconfig.setProperty("db.password", "");
        ...
        m_propsconfig.setProperty("db.driverlib", new File(new File(dirname), "lib/mysql-connector-java-3.1.14.jar").getAbsolutePath());           
        m_propsconfig.setProperty("db.driver", "org.gjt.mm.mysql.Driver");
        m_propsconfig.setProperty("db.URL", "jdbc:mysql://localhost:3306/posplus");
