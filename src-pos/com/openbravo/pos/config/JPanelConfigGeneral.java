...
//        jcboLAF.addItem(new UIManager.LookAndFeelInfo("Openbravo", "com.openbravo.pos.skin.OpenbravoLookAndFeel"));
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(20, 340, 130, 14);
        add(cboPrinters);
        cboPrinters.setBounds(150, 340, 180, 20);
        add(jtxtUserName);
        jtxtUserName.setBounds(90, 400, 180, 20);
        add(jtxtCompany);
        jtxtCompany.setBounds(90, 430, 180, 20);

        jtxtMachineID.setEditable(false);
        add(jtxtMachineID);
        jtxtMachineID.setBounds(360, 400, 180, 20);
        add(jtxtLicenseNumber);
        jtxtLicenseNumber.setBounds(360, 430, 180, 20);

        jLabel10.setText(AppLocal.getIntString("Label.CashMachine")); // NOI18N
        ...
        add(jLabel3);
        jLabel3.setBounds(20, 430, 60, 20);

        jLabel4.setText("Licensa");
        add(jLabel4);
        jLabel4.setBounds(280, 430, 60, 20);

        jLabel8.setText("Perdoruesi");
        add(jLabel8);
        jLabel8.setBounds(20, 404, 60, 20);

        jLabel11.setText("ID Makines");
        add(jLabel11);
        jLabel11.setBounds(280, 400, 60, 20);
        ...
        add(jLabel9);
        jLabel9.setBounds(20, 370, 640, 15);
